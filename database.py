...
def top_n_database(n=5):
    """
    Function that scraps the API of Spotify to get the top N tracks of the artists scrapped in scrapper.py.
    Parameters:
    - n: int. Any number between 1 and 10. Default value is 5.
    """
